...
\begin{document}
	\begin{titlepage}
		\begin{center}
			...
			Student \# 142062\\}
		\vspace{4cm}
			\centering{\includegraphics[scale=0.3]{figure/duet_logo.png}}\\
			\vspace{4cm}
...
\begin{figure}[htbp]
	\centering{\includegraphics[scale=0.6]{figure/16qamstandardM2M4error.eps}}
...
\begin{figure}[htbp]
	\centering{\includegraphics[scale=0.4]{figure/mmsVsSNR.eps}}
...
\begin{figure}[htbp]
	\centering{\includegraphics[scale=0.4]{figure/m2sVsSNR.eps}}
